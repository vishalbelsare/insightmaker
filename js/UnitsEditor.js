			...
			handler: function () {
				...
				var columnsList = [{
					...
					editor: {
						...
						regexText: getText("The unit name may only contain letters and spaces, and cannot start with a space")
					}
				}, {
					xtype: 'numbercolumn',
				...
				var grid = new Ext.grid.GridPanel({
					...
					tbar: [{
						...
						handler: function () {
							...
							editor.completeEdit();
							var inserted = store.insert(0, e);
							//store.getAt(0).setDirty();
							grid.getView().refresh();
							grid.getSelectionModel().select(inserted);
							editor.startEdit(inserted[0], 0);
						}
					}],
